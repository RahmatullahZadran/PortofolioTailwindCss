                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        {project.githubUrl && (
                          <div className="mt-4">
                            <text className="text-sm font-medium text-white">Links</text>
                            <a
                              ...
                              className="text-indigo-600 hover:text-indigo-900"
                            >
                              <img className={`h-4 w-4 sm:h-5 sm:w-5 animate-jumpy md:h-5 md:w-5 lg:h-5 lg:w-5 xl:h-6 xl:w-6 ? 'scale-110' : ''}`} src="https://firebasestorage.googleapis.com/v0/b/protofolio-44836.appspot.com/o/github%20(1).png?alt=media&token=eb89d9c4-1c80-4be8-8124-fc6dceb7add8" alt="URL Icon" />
                            </a>
                          </div>
                        )}
                      </div>
