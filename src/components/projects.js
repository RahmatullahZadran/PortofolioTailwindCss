...
export default function Example() {
  ...
  const [isQuickViewOpen, setIsQuickViewOpen] = useState(false); // State for the quick view
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <a
                      ...
                      onClick={(e) => e.stopPropagation()} // Prevent triggering the project click event
                    >
